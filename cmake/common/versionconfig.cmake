...
if(NOT DEFINED OBS_VERSION_OVERRIDE AND EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/.git")
  execute_process(
    # Tempest release tags use the tempest-v prefix. Ignore them here so the
    # separately displayed OBS engine version continues to resolve from an
    # upstream numeric OBS tag after a Tempest release is tagged.
