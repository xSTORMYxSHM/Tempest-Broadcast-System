...
set(TEMPEST_PRODUCT_VERSION "0.20.0" CACHE STRING "Tempest Broadcast product version")
set(TEMPEST_OBS_ENGINE_VERSION "32.1.2" CACHE STRING "Inherited OBS engine compatibility version")
...
# This repository intentionally has independent Tempest history rather than
# OBS release tags. Supply the inherited engine version explicitly so CMake,
# logs, and compatibility diagnostics remain numeric and stable.
if(NOT DEFINED OBS_VERSION_OVERRIDE)
  set(OBS_VERSION_OVERRIDE "${TEMPEST_OBS_ENGINE_VERSION}")
endif()
