...
if (-not $SkipBuild) {
    ...
    Invoke-Checked $cmake -S $projectRoot -B $buildDirectory "-DTEMPEST_PRODUCT_VERSION=${version}" -DENABLE_WHATSNEW=OFF -DENABLE_BROWSER=ON -DENABLE_COREAUDIO_ENCODER=OFF -DENABLE_TEMPEST_VERTICAL_CANVAS=ON
