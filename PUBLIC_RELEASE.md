...
The first supported public target is 64-bit Windows 10 or Windows 11. Version 0.20.0 is the first public preview and should remain marked as a prerelease until it has been tested with a fresh Windows account, common capture hardware, a real Twitch stream, and an installed-versus-portable upgrade cycle.
...
- `RELEASE_NOTES.md`, `NOTICE.txt`, and `PUBLIC_RELEASE.md`

The release notes and manifest must name the Tempest version, OBS engine version, source commit, unsigned/signed status, and known limitations.
...
- Create the versioned release notes at `docs/releases/<version>.md`.
