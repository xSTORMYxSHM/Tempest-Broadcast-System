...
The first supported public target is 64-bit Windows 10 or Windows 11. Version 0.16.0 should be presented as a public preview until it has been tested with a fresh Windows account, common capture hardware, a real Twitch stream, and an installed-versus-portable upgrade cycle.
