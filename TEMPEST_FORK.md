...
Current Tempest product version: **0.20.0**. The separate OBS engine version remains visible in the title bar so upstream compatibility can still be diagnosed accurately.
...
Upstream OBS updates should be reviewed and merged deliberately into `main`; do not enable the OBS binary updater for this fork.
