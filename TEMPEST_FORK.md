...
Current Tempest product version: **1.0.6**. The separate OBS engine version remains visible in the title bar so upstream compatibility can still be diagnosed accurately.
