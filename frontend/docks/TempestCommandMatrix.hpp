...
private:
	...
	struct SourceReaction {
		...
		double liftAmount = 24.0;
		bool swayEnabled = false;
		double swayAmount = 18.0;
		bool rotateEnabled = false;
		double rotateAmount = 2.0;
		bool visibilityEnabled = false;
		bool enabled = true;
		bool baselineCaptured = false;
		bool baselineVisible = true;
		bool visibilityActive = true;
		bool runtimeTransformApplied = false;
		bool runtimeVisibilityApplied = false;
	...
	void ApplyReactionPreset(int index);
	void MarkReactionPresetCustom();
	int ReactionEffectCount(const SourceReaction &reaction) const;
	...
	QPointer<QDoubleSpinBox> reactionLiftAmount;
	QPointer<QCheckBox> reactionSwayEnabled;
	QPointer<QDoubleSpinBox> reactionSwayAmount;
	QPointer<QCheckBox> reactionRotateEnabled;
	QPointer<QDoubleSpinBox> reactionRotateAmount;
	QPointer<QCheckBox> reactionVisibilityEnabled;
